    ...
    >
      <div class="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
        ...
        <div class="mb-3">
          ...
          <input
            type="text"
            class="w-full rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm outline-none focus:border-blue-500"
        ...
        <Show when={props.sourceTopics.length > 0}>
          <div class="mb-4">
            <label class="mb-2 block text-sm text-gray-600 dark:text-gray-300">
