...
/**
 * Modal for creating a new task (T6.4, FR-INT-010, FR-INT-011).
 * Title required, due date and topics optional.
...
export function CreateTaskModal(props: CreateTaskModalProps) {
  ...
  async function handleConfirm() {
    ...
    const dueVal = due().trim() || undefined;

    const task = await EntityService.createTask({
      title: titleVal,
      due: dueVal,
  ...
  return (
    ...
    >
      <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <h2 class="mb-4 text-lg font-semibold text-gray-800">New Task</h2>
